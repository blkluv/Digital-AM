...
const contactEmail = "hi@viraldental.marketing";
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-4 lg:px-8">
          <a href="/" className="flex items-center gap-3">
            <div>
              ...
              <div className="text-xs uppercase tracking-[0.18em] text-slate-400">Marketing · Web Design · Software · Automation</div>
            </div>
          </a>
